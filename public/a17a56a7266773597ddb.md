...
tags:
  - OEIS
private: false
updated_at: '2026-05-11T01:26:33+09:00'
...
[OEIS（The On-Line Encyclopedia of Integer Sequences）](https://oeis.org/)は、数列を収録したオンラインデータベースである。
...
全数列に登場した整数の集合を取得し、そこに含まれない正の整数を小さい順に探す。
...
def interesting_num(column):
    ...
    return Counter(all_integers).keys()  # 登場した整数の集合を返す
...
[OEISのGitHubリポジトリ](https://github.com/oeis/oeisdata)を用いて日次で集計する方法に変更し、集計結果を [https://manman4.github.io/](https://manman4.github.io/) に公開している。
